...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['business-owner', 'admin'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_received.update': { roles: ['business-owner', 'admin'], key: 'payment_id', tenantPath: [], userPath: [] },
  'low_inventory.update': { roles: ['business-owner', 'admin'], key: 'product_id', tenantPath: [], userPath: [] },
};
