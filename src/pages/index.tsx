  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Ecommerce Example: Building Your Online Presence with a Powerful Ecommerce Platform, Offering Seamless User Management, Product Database, and a Robust Admin Panel for Order Control."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2V8ZW58MHx8fHwxNjk1MzY0MDE4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Ecommerce Example: Building Your Online Presence with a Powerful Ecommerce Platform, Offering Seamless User Management, Product Database, and a Robust Admin Panel for Order Control.`}
            </Text>
            <Box
